...
namespace Violin.Store.Web.BackFront.Controllers
{
	...
	[AccessRequired(UserAccess.News)]
	public class NewsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "NewsID,ReleaseTime,Type,Title,Content")] News news)
        {
		...
		public ActionResult Edit([Bind(Include = "NewsID,ReleaseTime,Type,Title,Content")] News news)
        {
            if (ModelState.IsValid)
            {
