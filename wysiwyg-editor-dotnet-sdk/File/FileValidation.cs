...
namespace FroalaEditor
{
    ...
    public class FileValidation
    {
        ...
        /// </summary>
        public static string[] AllowedFileExtsDefault = new string[] { "txt", "pdf", "doc", "jpg", "jpeg", "png", "gif"};

        /// <summary>
        /// Allowed file validation default mimetypes.
        /// </summary>
        public static string[] AllowedFileMimetypesDefault = new string[] { "text/plain", "application/msword", "application/x-pdf", "application/pdf", "image/jpeg", "image/png", "image/gif" };
